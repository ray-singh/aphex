...
logger = logging.getLogger("aphex.benchmark")
...
def _is_pruning_backend(backend: str) -> bool:
    """Local check to avoid importing aphex.pruning at module-load time."""
...
def _serialize_model(
    ...
    from aphex.inspector import _STUB_REGISTRY
...
def _deserialize_model(model_payload: tuple[Any, ...]) -> Any:
    ...
    from aphex.inspector import _patch_stub_forwards
...
def _prepare(
    ...
    if candidate.backend == "pytorch_int8_dynamic":
        ...
        from aphex.pruning import prune_model, spec_for_backend
