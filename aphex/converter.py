...
def _convert_sklearn_onnx(
    ...
    from aphex.plugins.sklearn import _detect_framework, _export_to_onnx, _get_n_features
...
def _convert_tensorrt(
    ...
    from aphex.benchmark import _make_trt_calibrator
...
def read_deployment_yaml(path: Path, *, strict: bool = False) -> dict:
    ...
    """
    import logging
    _log = logging.getLogger("aphex.converter")
